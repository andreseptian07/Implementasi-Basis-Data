...
<table >
 <tr>
 <center>
  <td> <input type='text' name='input_cari' placeholder="Cari Nama Siswa"> </td>
...
<?php  
// Perintah untuk menampilkan data tidak lulus
$queri="Select * From siswa where nilai_akhir < 75" ;  
